...
### Change me! ###
n_interpolation = 12 # Choose the interpolation: how many intermediate images you want + 2 (for the start and end image)
...
n_interpolation = 12 # How many intermediate images you want + 2 (for the start and end image)
